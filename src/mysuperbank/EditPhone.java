 ...
 * @author Mohaned
 */
public class EditPhone extends javax.swing.JFrame {

    /**
     * Creates new form EditPhone
     */
    public EditPhone() {
        initComponents();
    }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if(isValid){
            try{
                if(s.editPhone(Integer.parseInt(idField.getText()), phoneField.getText())){
...
//            java.util.logging.Logger.getLogger(EditPhone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
